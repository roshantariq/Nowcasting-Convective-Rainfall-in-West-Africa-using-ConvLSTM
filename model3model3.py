...
def create_shifted_frames(data):
    x = data[:, [0,2], :, :, :]  # 1,3 frames as input
    y = data[:, 3:, :, :, :]  # Next 2 frames as output
    return x, y
...
try:
    with open('model3model3_lr.json', 'w', encoding='utf-8') as f:
...
try:
    with open('model3model3_lr.json', 'r', encoding='utf-8') as f:
